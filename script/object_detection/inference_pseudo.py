...
##########################################SET DIRECTORY#########################################
MODEL_DIR_NAME = (  # change this!! directory name of the trained model
    "delineator_post"
)
TRAINED_MODEL_DIR = (
    "/home/ofotechjkr/workspace/tensorflow_OD/ofotech_train/models"
)
MODEL_DATE = "20200711"
...
def xml_inference(model, image_file):
    ...
    for obj in objects:
        ...
        imageOutputFilename = os.path.join(
            imageSaveDir, imageNameOnly
        )
...
for image_file in IMAGE_PATHS:
    ...
    print(
        "Processing Time per Image: {} seconds".format(elapsed_time)
    )
